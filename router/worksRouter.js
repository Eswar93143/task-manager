...
const { getWorks, getWorkById, createWork, updateWork, deleteWork, getTasks, getTaskById, createTask, updateTask, deleteTask, dragTask, addStatus, updateStatus } = require('../controllers/worksController');
...
// status
worksRouter.patch('/task/drag', dragTask);
worksRouter.post('/status', addStatus);
worksRouter.patch('/status/:workId/:status', updateStatus);
